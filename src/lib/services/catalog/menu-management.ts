...
export async function listProductCategories(
  ...
  return unwrapApiResult(response.data, "Không thể tải danh mục sản phẩm.");
}
...
export async function createProductCategory(
  ...
  return unwrapApiResult(response.data, "Không thể tạo danh mục sản phẩm.");
}
...
export async function updateProductCategory(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật danh mục sản phẩm.");
}
...
export async function setProductCategoryStatus(
  ...
  return unwrapApiResult(response.data, "Không thể đổi trạng thái danh mục sản phẩm.");
}
...
export async function cloneProductTemplate(
  ...
  return unwrapApiResult(response.data, "Không thể tạo sản phẩm từ mẫu.");
}
...
export async function getProductById(
  ...
  return unwrapApiResult(response.data, "Không thể tải chi tiết sản phẩm.");
}
...
export async function createManagementProduct(
  ...
  return unwrapApiResult(response.data, "Không thể tạo sản phẩm.");
}
...
export async function updateManagementProduct(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật sản phẩm.");
}
...
export async function deleteManagementProduct(
  ...
  return unwrapApiResult(response.data, "Không thể xóa sản phẩm.");
}
...
export async function createManagementProductVariant(
  ...
  return unwrapApiResult(response.data, "Không thể tạo biến thể sản phẩm.");
}
...
export async function updateManagementProductVariant(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật biến thể sản phẩm.");
}
...
export async function deleteManagementProductVariant(
  ...
  return unwrapApiResult(response.data, "Không thể xóa biến thể sản phẩm.");
}
...
export async function setProductAvailability(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật trạng thái sản phẩm.");
}
...
export async function setProductVariantAvailability(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật trạng thái biến thể.");
}
...
export async function createOptionGroup(
  ...
  return unwrapApiResult(response.data, "Không thể tạo nhóm tùy chọn.");
}
...
export async function updateOptionGroup(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật nhóm tùy chọn.");
}
...
export async function deleteOptionGroup(
  ...
  return unwrapApiResult(response.data, "Không thể xóa nhóm tùy chọn.");
}
...
export async function createProductOption(
  ...
  return unwrapApiResult(response.data, "Không thể tạo tùy chọn.");
}
...
export async function updateProductOption(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật tùy chọn.");
}
...
export async function setProductOptionAvailability(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật trạng thái tùy chọn.");
}
...
export async function deleteProductOption(
  ...
  return unwrapApiResult(response.data, "Không thể xóa tùy chọn.");
}
...
export async function createRecipe(
  ...
  return unwrapApiResult(response.data, "Không thể tạo công thức.");
}
...
export async function updateRecipe(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật công thức.");
}
...
export async function setRecipeStatus(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật vòng đời công thức.");
}
...
export async function createRecipeVersion(
  ...
  return unwrapApiResult(response.data, "Không thể tạo phiên bản công thức mới.");
}
...
export async function getMenuById(
  ...
  return unwrapApiResult(response.data, "Không thể tải chi tiết thực đơn.");
}
...
export async function setMenuStatus(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật trạng thái thực đơn.");
}
...
export async function createManagementMenu(
  ...
  return unwrapApiResult(response.data, "Không thể tạo thực đơn.");
}
...
export async function updateManagementMenu(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật thực đơn.");
}
...
export async function deleteManagementMenu(
  ...
  return unwrapApiResult(response.data, "Không thể xóa thực đơn.");
}
...
export async function createManagementMenuItem(
  ...
  return unwrapApiResult(response.data, "Không thể thêm món vào thực đơn.");
}
...
export async function updateManagementMenuItem(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật món trong thực đơn.");
}
...
export async function deleteManagementMenuItem(
  ...
  return unwrapApiResult(response.data, "Không thể xóa món khỏi thực đơn.");
}
...
export async function setMenuItemStatus(
  ...
  return unwrapApiResult(response.data, "Không thể cập nhật trạng thái món.");
}
