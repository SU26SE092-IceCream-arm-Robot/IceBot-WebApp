...
import { useNotificationDeliveries } from "@/hooks/operations/use-notification-deliveries";
import {
...
} from "@/lib/services/operations/notification-deliveries";
import type { FranchiseOnboardingResult } from "@/types/tenants/franchise-onboarding";
import type { NotificationDeliveryResult } from "@/types/operations/notification-deliveries";

vi.mock("sonner", () => ({ toast: { success: vi.fn() } }));
vi.mock("@/lib/services/tenants/franchise-onboarding", () => ({
...
vi.mock("@/lib/services/operations/notification-deliveries", () => ({
