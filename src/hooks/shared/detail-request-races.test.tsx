...
import type { InternalAccountResult } from "@/types/identity/accounts";
import type { AlertResult } from "@/types/operations/alerts";
import type { OrderResult } from "@/types/transactions/transactions";
...
vi.mock("@/lib/services/identity/roles", () => ({
