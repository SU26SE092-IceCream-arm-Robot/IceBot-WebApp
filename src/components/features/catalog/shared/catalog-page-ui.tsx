...
import { CatalogEmptyMarker, MenusTable, ProductsTable } from "@/components/features/catalog/shared/catalog-tables";
...
import type { MenuCollectionState } from "@/hooks/catalog/use-menu-management";
import type {
