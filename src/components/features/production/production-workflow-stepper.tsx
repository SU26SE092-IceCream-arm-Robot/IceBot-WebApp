...
const STEPS = [
  {
    number: 1 as const,
    title: "Chương trình robot",
    description:
      "Nhập bundle, tạo program, sắp thứ tự và phát hành tài nguyên.",
    icon: Upload,
  },
  {
    number: 2 as const,
    title: "Liên kết cấu hình",
  ...
  },
  {
    ...
    description:
      "Chuyển sang Kiosk, kiểm tra endpoint và triển khai phiên bản.",
    icon: Rocket,
  },
];
...
export function ProductionWorkflowStepper({
  ...
  return (
    <aside
      className="relative xl:min-w-44"
      aria-label="Tiến trình cấu hình sản xuất"
    >
      <Button
        size="sm"
        variant="outline"
      ...
      >
        ...
        {isOpen ? "Thu gọn luồng" : "Xem luồng"}
      </Button>
      {isOpen ? (
        <div
          id="production-workflow-steps"
          className="mt-3 rounded-lg border bg-card p-4 shadow-sm xl:absolute xl:right-0 xl:z-20 xl:w-[760px]"
        >
          <div className="mb-4">
