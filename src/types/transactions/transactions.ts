import type { PagedResult, PaginationMeta } from "@/types/identity/accounts";
...
export interface PaymentSessionInterventionResult {
  paymentTransactionId: string;
  orderId: string;
  orderNumber: string;
  organizationId?: string | null;
...
export interface PaymentSessionInterventionsQuery {
  provider?: string;
  interventionCode?: string;
  organizationId?: string;
  storeId?: string;
...
export interface ManualPaymentSessionReconciliationResult {
  paymentTransactionId: string;
  orderId: string;
  outcome: string;
  status: string;
...
export interface OpenProductionIncidentRequest {
  sourceCommandId: string;
